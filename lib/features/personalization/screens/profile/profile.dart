...
import 'package:sos/features/personalization/screens/profile/widgets/profile_menu.dart';
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              TProfileMenu( title: 'Name', value: 'สมศรี', onPressed: () {},),
              TProfileMenu(title: 'Username', value: 'ส้ม', onPressed: () {}),
              ...
              TProfileMenu(title: 'E-mail', value: 'somsri@gmail.com', onPressed: () {}),
              TProfileMenu(title: 'Phone Number', value: '+66-0817593379', onPressed: () {}),
              TProfileMenu(title: 'Gender', value: 'Female', onPressed: () {}),
              TProfileMenu(title: 'Date of Birth', value: '01 fab, 2005', onPressed: () {}),
              const Divider(),
              const SizedBox(height: TSizes.spaceBtwItems),
