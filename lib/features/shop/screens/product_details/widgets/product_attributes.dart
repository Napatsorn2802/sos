            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      Row(
                        children: [
                          const TProductTitleText(title: 'ราคา : ', smallSize: true),
                      ...
                      Row(
                        children: [
                          const TProductTitleText(title: 'คลังสินค้า : ', smallSize: true),
                ...
                const TProductTitleText(
                  title: 'ต้นมะเขือเทศจากจังหวัดสระบุรีเพาะปลูกจากมะเขือเทศพันดีรสชาติหวานอมเปรี้ยว.',//คำอธิบายสินค้า
                  smallSize: true,
                  maxLines: 4,
              ),
            ],
            ...
            Column(
              ...
              children: [
                ...
                Wrap(
                  spacing: 8,
                  children: [
                    TChoiceChip(text: 'ต้นเล็ก', selected: true, onSelected: (value){}),
